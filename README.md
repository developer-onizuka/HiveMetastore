...
If mongoDB is updated, then you should load it into DataFrame with spark.read.format("mongo") and saveAsTable() again so that the Hive Metastore can be updated.
